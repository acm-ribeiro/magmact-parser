...
public class magmactLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__25", "T__26", "T__27", "T__28", "T__29", "T__30", "THIS", "STRING", 
			"INT", "RBAR", "LCURL", "RCURL", "LPAR", "RPAR", "LSTR8", "RSTR8", "NEWLINE", 
			"WS"
		};
	}
	...
	public magmactLexer(CharStream input) {
		super(input);
		_interp = new LexerATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}

	@Override
	public String getGrammarFileName() { return "apostl.g4"; }
